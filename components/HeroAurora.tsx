...
export default function HeroAurora({
  badge = "FITFORGE GYM",
  headline = "TRAIN HARD. STAY UNSTOPPABLE.",
  subheadline = "High-intensity classes, expert coaches, and a community built to push your limits every single day.",
  primaryCta = { label: "Start Free Trial", href: "#" },
  secondaryCta = { label: "View Class Schedule", href: "#" },
  ...
  return (
    <AuroraBackground auroraColors={["#ef4444", "#f97316", "#ef4444", "#f97316", "#ef4444"]}>
      ...
      >
        ...
        <TextGenerateEffect words={headline} className="text-4xl font-bold text-center tracking-tight text-foreground sm:text-5xl md:text-6xl lg:text-7xl max-w-4xl" />
